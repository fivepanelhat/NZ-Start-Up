# Legal Boundaries (Human-Readable)

See also `compliance/legal-boundaries-nz.md`.
...
Generic agent platforms skip NZ law. This fleet encodes ceilings so founders do not buy a liability machine.

## Confirm before commercial claims
