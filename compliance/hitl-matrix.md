...
| content-comms-officer | Draft posts, press kits | Publish/schedule unless pre-approved | Impersonating founder voice without profile |
| finance-clerk | Triage categories, GST worksheet prep, runway math from given numbers | Filing GST/income tax, payments | Moving money; tax agent acts |
| funding-analyst | Investor lists, deck outlines, cap table scenarios | Signing term sheets, fundraising comms as advice | Regulated financial advice |
| legal-document-assistant | Template-based first drafts | Signing, sending as final | Unauthorised legal practice |
| board-chief-of-staff | Aggregate reports, route tasks, escalate | Final strategic decisions | Deciding as the board |

## Global HITL triggers
