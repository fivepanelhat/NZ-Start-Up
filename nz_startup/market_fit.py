...
SEGMENTS: dict[str, dict[str, Any]] = {
 ...
 "S6": {
 "name": "Maori / iwi-linked ventures",
...
ENTERPRISE_PRODUCTS: list[dict[str, Any]] = [
 ...
 "buyer": "Iwi / Maori enterprise (gated)",
...
PORTFOLIO: list[dict[str, Any]] = [
 ...
 {"repo": "whanau-preterm-support-hub", "total": 19, "role": "Social impact", "buyer": "Whanau / health"},
 {"repo": "Front_Line_Whanau", "total": 19, "role": "Frontline services", "buyer": "Whanau / NGOs"},
