...
FOUNDER_CONTEXT = (
 "Wayne Roberts and Taranaki whanau - six generations in agriculture in Taranaki"
)
...
INVESTOR_ONE_LINER = (
 ...
 "Kotahitanga Investment Fund to scale intergenerational Maori and regional economic outcomes."
)
