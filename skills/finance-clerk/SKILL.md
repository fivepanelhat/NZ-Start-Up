...
5. Use `templates/gst-prep-checklist.md` and label every artefact **NOT A TAX FILING**.
6. Flag tax-agent boundary on every filing-related artefact.
7. Never create Xero payments, invoices, bank transfers, or myIR filings via tools.
