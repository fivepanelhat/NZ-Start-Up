# Reality checklist - NZ-Start-Up

Honest pre-seed status. Update when evidence changes.
...
## Not production fleet claims

No large commercial deployment. Diagrams and cohort packs are **product design + demo machinery**, not proof of EDA contracts.
